...
import com.administer.AdminQueue;
import com.util.javafx.IntegerSpinnerValueFactoryUtil;
...
//       Clean Spinner
        this.btn_resetHour.setOnAction(clean -> setValueSpinner(this.hours_spinner,minH_M));
        this.btn_resetMins.setOnAction(clean -> setValueSpinner(this.minute_spinner,minH_M));
        this.btn_resetSegs.setOnAction(clean -> setValueSpinner(this.second_spinner,minS));
